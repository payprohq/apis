...
```
implementation 'mn.lambda:paypro-sdk:1.0.64'
```
...
`uid` нь картын үндсэн сериал дугаар, `fullUid` нь картын бүтэн UID утга байна. Зарим картын хувьд `fullUid` нь `uid`-тай ижил утгатай байж болно.
