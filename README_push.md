...
Холболтонд өгсөн `api-key`,`client-id`  утгыг Request Header-т дараах байдлаар дамжуулна
...
API сервис тус бүрийн хаяг рүү хүсэлт илгээх ба `API_BASE_URL` болон `api-key`,`client-id` мэдээллийг холболт хийх үед олгоно
